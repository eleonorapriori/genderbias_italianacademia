...
globals [turnover
         ...
         shareOfFemales
         competitions
         femaleDiscriminations
         maleDiscriminations
         discriminationRate
         maleDiscriminationRate
...
to setup
 ...
 set pubdataF remove-item 0 csv:from-file "scival_females.csv"
  ...
  ask turtles with [gender = "M"] [set productivity item 0 one-of pubdataM * weight-of-productivity]
  ask turtles with [gender = "F"] [set productivity item 0 one-of pubdataF * weight-of-productivity]
...
to go
  ...
  ask turtles [set productivityT-1 productivity
               set productivity productivityT-1 * (1 + random-normal 0.02 variance-incr-in-prod) ;increase in avg productivity due to seniority (filpas)
               if productivity < productivityT-1 [set productivity productivityT-1]
               ]

  let newMothers n-of (0.5 * count turtles with [gender = "F" and age < 45 and sons < 3]) turtles with [gender = "F" and age < 45 and sons < 3] ; look for data on maternity
  ...
  if motherhood-bonus? [let bonus (mean[productivity] of turtles - mean[productivityT-1] of turtles) ;* 0.5
  ...
  let PAoutside precision (0.25 * count rtdbs with [yearsOfContract = 3]) 0 ; 0.25 perchè 0.18/0.78 da dati Marianna
  let POoutside precision (0.05 * count rtdbs with [yearsOfContract = 3]) 0 ; 0.05 perchè 0.03/0.78 da dati Marianna
 ...
 ;COMPETITIONS PA -> PO
  ...
  set femaleDiscriminations []
  set maleDiscriminations []


  ifelse gender-quotas-in-full? [let male-competitions precision (competitions * 0.4) 0 ;either : let male-competitions 0 (only open competitions after quotas)
      ...
      repeat male-competitions [ask pos [set evaluatorsPO false]
                                ...
                                ask pas with [gender = "M" and curriculum > 72][set eligiblePO true]
      ...
      repeat female-competitions [ask pos [set evaluatorsPO false]
                                  ...
                                  ask pas with [gender = "F" and curriculum > 72 * (female-reluctance-to-apply)][set eligiblePO true]
      ...
      repeat open-competitions [ask pos [set evaluatorsPO false]
                              ...
                              ifelse no-diff-in-curriculum? [ask pas with [curriculum > 72] [set eligiblePO true]
                                                             ]
                                    [ask pas with [gender = "M" and curriculum > 72][set eligiblePO true] ; 72 minima età teorica + avg m&F prod
                                     ask pas with [gender = "F" and curriculum > 79.2] [set eligiblePO true] ; threshold maschi +10% per recluntancy (studies and education --> meno prob di abilitarsi)
                                                            ]
                           ...
                           ask commissionPO [create-links-to competitorsPO
                                         ;evaluation of the committees to male candidates
                                          ...
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 + random max-bias) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 2 [
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 + random (max-bias / 2)) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 1 [
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 - (max-bias / 6) + random (max-bias / 3)) * (0.9 + random-float 0.2)]
                                                                                     ]
                                         ...
                                         ;evaluation of the committees to female candidates
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 3 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 - random max-bias) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 2 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 - random (max-bias / 2)) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 1 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 - (max-bias / 6) + random (max-bias / 3)) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 0 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 + random max-bias) * (0.9 + random-float 0.2)]
                                                                                     ]
  ...
  [repeat competitions [ask pos [set evaluatorsPO false]
      ...
      ifelse no-diff-in-curriculum? [ask pas with [curriculum > 72] [set eligiblePO true]
                         ...
                         ask commissionPO [create-links-to competitorsPO
                                         ;evaluation of the committees to male candidates
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 3 [
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 + random 30) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 2 [
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 + random 15) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 1 [
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 - 5 + random 10) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 0 [
                                          ask my-links with [[gender] of end2 = "M"][set evaluation ([curriculum] of end2 - random 30) * (0.9 + random-float 0.2)]
                                                                                     ]
                                         ;evaluation of the committees to female candidates
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 3 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 - random 30) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 2 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 - random 15) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 1 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 - 5 + random 10) * (0.9 + random-float 0.2)]
                                                                                     ]
                                          if count pos with [evaluatorsPO = true and gender = "M"] = 0 [
                                          ask my-links with [[gender] of end2 = "F"][set evaluation ([curriculum] of end2 + random 30) * (0.9 + random-float 0.2)]
                                                                                     ]
     ...
     let first-woman-losing max[curriculum] of turtles with [curriculum = max[curriculum] of pas with [gender = "F" ] and gender = "F" and winner = false]
     set femaleDiscriminations fput count turtles with [winner = true and gender = "M" and curriculum < first-woman-losing] femaleDiscriminations

     let first-male-losing max[curriculum] of turtles with [curriculum = max[curriculum] of pas with [gender = "M" ] and gender = "M" and winner = false]
     if count turtles with [winner = true and gender = "F" and curriculum < first-male-losing]  != 0 [
     set maleDiscriminations fput count turtles with [winner = true and gender = "F" and curriculum < first-male-losing] maleDiscriminations
                                                                                                    ]


     let firstLosers pas with [gender = "F" and winner = false and curriculum = max[curriculum] of pas with [gender = "F" and winner = false]]
     if [curriculum] of competitorsPO with [gender = "M" and winner = true] != [][set minProdM mean [curriculum] of competitorsPO with [gender = "M" and winner = true]]
     if [curriculum] of competitorsPO with [gender = "F" and winner = false] != [][set maxProdF mean [curriculum] of firstLosers]
                         ]


    if femaleDiscriminations != [] [set femaleDiscriminations max femaleDiscriminations]
    if femaleDiscriminations != [] and competitions != 0 [set discriminationRate 100 * precision (femaleDiscriminations / competitions) 2]

    if maleDiscriminations != [] [set maleDiscriminations max maleDiscriminations]
    if maleDiscriminations != [] and competitions != 0 [set maleDiscriminationRate 100 * precision (maleDiscriminations / competitions) 2]
  ]
  ]
...
1649
371
cv of male winners vs female losing
NIL
NIL
0.0
10.0
...
"" ""
PENS
"default" 1.0 2 -2064490 true "" "if ticks > 0 [plot maxProdF]"
"pen-1" 1.0 2 -13345367 true "" "if ticks > 0 [plot minProdM]"
...
"" ""
PENS
"default" 1.0 0 -2064490 true "" "plot discriminationRate"
"pen-1" 1.0 0 -14070903 true "" "plot maleDiscriminationRate"
...
<experiments>
  <experiment name="experiment 1" repetitions="50" runMetricsEveryStep="true">
    ...
    <metric>count turtles with [winner = true and gender = "M"]</metric>
    <metric>count turtles with [winner = true and gender = "F"]</metric>
    <metric>femaleDiscriminations</metric>
    <metric>maleDiscriminations</metric>
    <enumeratedValueSet variable="motherhood-bonus?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="hiring-from-outside?">
      <value value="false"/>
    </enumeratedValueSet>
  ...
  <experiment name="experiment 8" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [gender = "M"]</metric>
  ...
  <experiment name="experiment 9" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [gender = "M"]</metric>
  ...
  <experiment name="experiment 10" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [gender = "M"]</metric>
